...
namespace KALAYUNITSM.COMMON
{
    ...
    public static class Tools
    {
        ...
        {
            Random random = new Random();
            string strRandom = random.Next(100, 1000).ToString(); //生成编号 
        ...
        public static string CreateNoWithPreFix(string prefix)
        {
            ...
            string code = prefix + "-" + DateTime.Now.ToString("yyyyMMdd") + strRandom + Guid.NewGuid().ToString("N").Substring(0, 4);
            return code;
        }
        #endregion
        ...
        public static List<listview> ToListItem<T>()
        {
            List<listview> li = new List<listview>();
        ...
        public static List<listview> ToListItemDesc<T>()
        {
            Dictionary<string, string> nn = BindEnums(typeof(T));
            List<listview> li = new List<listview>();
            foreach (int s in Enum.GetValues(typeof(T)))
            {
                li.Add(new listview
                {
                    Value = Enum.GetName(typeof(T), s),
                    Text = nn[Enum.GetName(typeof(T), s)]
                }
                        );
            }
            return li;
        ...
        public static List<listview> ToListItemDesc<T>(int ex, int max = 0)
        {
            Dictionary<string, string> nn = BindEnums(typeof(T));
            List<listview> li = new List<listview>();
            foreach (int s in Enum.GetValues(typeof(T)))
