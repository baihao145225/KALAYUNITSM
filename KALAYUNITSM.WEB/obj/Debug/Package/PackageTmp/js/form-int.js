$.modalOpen = function (options) {
    ...
    top.layer.open({
        ...
        cancel: function (index) {
            layer.confirm('是否关闭当前窗口？', {
                btn: ['确定', '放弃'], title: ' 系统提示'
            }, function (index1) {
                layer.close(index1);
                layer.close(index);
            }, function (index1) {
...
$.modalOpenFull = function (options) {
    var defaults = {
        loading: true,
        type: 2,
        id: null,
...
$.modalMsg = function (content, type) {
    if (type != undefined) {
        ...
        top.layer.msg(content, { icon: icon, time: 6000, shift: 5 });
        top.$(".layui-layer-msg").addClass('layui-layer-msg-' + type);
...
$.currentWindow = function () {
    return top.frames['layui-layer-iframe'];
}
$.reload = function () {
    location.reload();
    return false;
...
$.downloadForm = function (options) {
    ...
    window.setTimeout(function () {
        ...
        $.ajax({
            ...
            complete: function () { location.href = options.fileurl }
        });
    }, 500);
}
    ...
    window.setTimeout(function () {
        ...
        $.ajax({
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                $.loading(false);
                $.modalAlert('系统错误：' + errorThrown, "error");
            },
            beforeSend: function () {
                $.loading(true, options.loading);
            },
...
$.fn.formSerialize = function (formdate, item) {
    var element = $(this);
    if (!!formdate) {
...
$.fn.bindString = function (options) {
    var defaults = {
        url: ""
    };
    var options = $.extend(defaults, options);
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".CerCloud_iframe:visible").attr("id").substr(6);
